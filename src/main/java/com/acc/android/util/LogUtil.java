...
public class LogUtil extends BaseLogUtil {
	...
	private static void log(Object tagObject, Object prefixObject,
		...
		String tagString = logType == com.acc.android.util.constant.ACCALibConstant.LOG_TYPE_SYSTEMOUT
				|| logType == com.acc.android.util.constant.ACCALibConstant.LOG_TYPE_FILE ? null
				: getTagString(tagObject, jsonManager);
		String logString = getLogString(prefixObject, informationObject);
		switch (logType) {
		case com.acc.android.util.constant.ACCALibConstant.LOG_TYPE_SYSTEMOUT:
			BaseLogUtil.systemOut(logString);
			break;
		case com.acc.android.util.constant.ACCALibConstant.LOG_TYPE_FILE:
	...
	public static void systemOut(Object informationObject) {
		log(null,
				null,
				informationObject,
				com.acc.android.util.constant.ACCALibConstant.LOG_TYPE_SYSTEMOUT);
	}
	...
	public static void fileOut(Object informationObject) {
		log(null,
				null,
				informationObject,
				com.acc.android.util.constant.ACCALibConstant.LOG_TYPE_FILE);
	}

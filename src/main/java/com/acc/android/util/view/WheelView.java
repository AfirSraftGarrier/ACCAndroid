...
public class WheelView extends View {
	...
	public void setCurrentItemValue(int value) {
		this.setCurrentItem(value - this.adapter.getMinValue());
	}

	public int getCurentItemValue() {
		return this.getCurrentItem() + this.adapter.getMinValue();
	}
	...
	private void initResourcesIfNecessary() {
		...
		if (centerDrawable == null) {
			centerDrawable = getContext().getResources().getDrawable(
					ResourceUtil.getDrawableId(context, "wheel_val")
		...
		setBackgroundResource(ResourceUtil.getDrawableId(context, "wheel_bg")
		// R.drawable.wheel_bg
		);
	}

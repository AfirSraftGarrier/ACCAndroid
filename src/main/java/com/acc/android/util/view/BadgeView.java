...
public class BadgeView extends TextView {
	...
	public static void showTagBadgeView(Context context, String showString,
			View view) {
		...
		badgeView.setText(showString);
		badgeView.show();
	}

	public static void hideTagBadgeView(View view) {
		Object badgeViewObject = view.getTag();
		if (badgeViewObject != null && badgeViewObject instanceof BadgeView) {
			((BadgeView) badgeViewObject).hide();
		}
	}
}
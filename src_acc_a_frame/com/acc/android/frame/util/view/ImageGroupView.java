...
import com.acc.android.frame.manager.BitmapProviderManager;
import com.acc.android.frame.model.ImageData;
import com.acc.android.frame.util.CompressPictureUtil;
import com.acc.android.frame.util.CompressPictureUtil.OnCompressPictureOverListener;
...
import com.acc.android.frame.util.widget.adapter.ImageAdapter;
import com.acc.android.frame.util.widget.adapter.ImageAdapter.LocalFileAction;
import com.acc.frame.util.StringUtil;
import com.acc.frame.util.callback.ACCFileCallback;
import com.acc.frame.util.callback.ACCImageGroupViewCallback;
...
public class ImageGroupView extends RelativeLayout
		implements
		com.acc.android.frame.util.interf.MediaActivityInterface.OnActivityResultListener,
